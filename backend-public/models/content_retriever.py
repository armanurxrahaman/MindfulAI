...
class ContentRetriever:
    def __init__(self, persist_directory: str = "/tmp/data"):
        """
    ...
    def get_random_content(self, n_results=3):
        # Always return a non-empty hardcoded list for daily inspiration
        all_content = [
            {"text": "Take a deep breath and smile.", "metadata": {"type": "Inspiration"}},
            {"text": "Remember, you are stronger than you think.", "metadata": {"type": "Motivation"}},
            {"text": "Practice gratitude today.", "metadata": {"type": "Mindfulness"}},
            {"text": "Reach out to a friend and share a kind word.", "metadata": {"type": "Connection"}},
            {"text": "Go for a short walk and notice your surroundings.", "metadata": {"type": "Wellness"}},
            {"text": "Write down three things you are grateful for.", "metadata": {"type": "Gratitude"}},
            {"text": "Listen to your favorite song and relax.", "metadata": {"type": "Joy"}},
        ]
        return random.sample(all_content, min(n_results, len(all_content))) 